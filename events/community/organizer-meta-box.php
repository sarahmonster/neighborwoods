...
<tr class="organizer">
	<td><label <?php if (isset($tribe_organizer_id) && $tribe_organizer_id && $_POST && empty($_OrganizerOrganizer)) echo 'class="error"'; ?>><?php _e( 'Organization' , 'tribe-events-community' ); ?></label></td>
	<td>
