...
<form method="post" action="">
   ...
   <div class="events-community-post-title"><label for='post_title' <?php if ( $_POST && empty( $venue->post_title ) ) echo 'class="error"'; ?>><?php _e( 'Site Name', 'tribe-events-community' ); ?></label> <small class="req">(required)</small><input type="text" name="post_title" value="<?php if ( isset( $venue->post_title ) ) echo esc_html( $venue->post_title ); ?>"/></div>
   <div class="events-community-post-content">
      <label for='post_content'><?php _e( 'Site Description', 'tribe-events-community' ); ?></label> <small class="req"></small>
   ...
   if ( $tribe_venue_id ) {
    _e( 'Update Site', 'tribe-events-community' );
  } else {
  	_e( 'Submit Site', 'tribe-events-community' );
  }
