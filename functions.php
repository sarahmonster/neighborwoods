...
function boilerplate_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Header Widget', 'boilerplate' ),
		'id' => 'header widget',
		'description' => __( 'Widgetized area for welcome text within the header.', 'boilerplate' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '',
		'after_title' => '',
	...
	register_sidebar( array(
		'name' => __( 'Sidebar Area', 'boilerplate' ),
		'id' => 'sidebar-area',
		'description' => __( 'Widgetized sidebar area for slideshow images.', 'boilerplate' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '',
		'after_title' => '',
	...
	// Area 2, located below the Primary Widget Area in the sidebar. Empty by default.
	register_sidebar( array(
		'name' => __( 'Homepage Widgets', 'boilerplate' ),
		'id' => 'homepage-one',
		'description' => __( 'Widgetized homepage area for intro and announcements.', 'boilerplate' ),
	...
	// Area 2, located below the Primary Widget Area in the sidebar. Empty by default.
	register_sidebar( array(
		'name' => __( 'More Homepage Widgets', 'boilerplate' ),
		'id' => 'homepage-two',
		'description' => __( 'Widgetized homepage area, mostly for Twitter feed.', 'boilerplate' ),
		'before_widget' => '<div id="twitter">',
		'after_widget' => '<a id="followus" href="http://twitter.com/NeighborWoods">Follow us @NeighborWoods</a></div>',
		'before_title' => '<h2>',
		'after_title' => '</h2>',
	) );
	...
	register_sidebar( array(
		'name' => __( 'Sponsors', 'boilerplate' ),
		'id' => 'first-footer-widget-area',
		'description' => __( 'The first footer widget area.', 'boilerplate' ),
		'before_widget' => '<div class="grid_5 alpha sponsors">',
		'after_widget' => '</div>',
		'before_title' => '',
		'after_title' => '',
	) );
	...
	register_sidebar( array(
		'name' => __( 'ACTrees Logo', 'boilerplate' ),
		'id' => 'second-footer-widget-area',
		'description' => __( 'The second footer widget area.', 'boilerplate' ),
		'before_widget' => '<div class="grid_3" id="actrees_logo">',
		'after_widget' => '</div>',
		'before_title' => '',
		'after_title' => '',
	) );
	...
	register_sidebar( array(
		'name' => __( 'Address and Social Media Links', 'boilerplate' ),
